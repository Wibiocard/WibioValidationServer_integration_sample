...
(() =>
{
    ...
    function Reader(index, name, atr)
    {
        ...
        self.connect = () =>
            navigator.wibioWebcard.send(2, { r: self.index });
    ...
    function WebCard()
    {
        ...
        // Encrypt message and return result
        self.encrypt = (message) =>
            self.send(6, { r: self.index, a: message });

        // Show finger modal
        self.showFingerModal = () =>
            self.send(100);
        // Hide finger modal
        self.hideFingerModal = (prevCmdI) =>
            self.send(101, { prevCmdI });
        ...
        self.responseCallback = (msg) =>
        {
            ...
            if (msg.e)
            {
                switch (msg.e)
                {
                    ...
                    // [Message bigger then 100]
                    case 100: case 101:
                    {
                        self.pendingRequests.get(msg.i)?.resolve(msg.i)
                        break;
                    }
                }
            ...
            else switch (request.c)
            {
                ...
                // [Connect] and [Transceive] and [Encrypt]
